...
public class HorizontalCalendarView extends LinearLayout {
    ...
    public void setUpCalendar(long start, long end, ArrayList<String> dates, OnCalendarListener onCalendarListener, int drawable) {
        ...
        long today = Utils.getTimeInMillis(Utils.getFormattedDateToday());
...
//        HorizontalCalendarAdapter adapter = new HorizontalCalendarAdapter(list, context, drawable);
        HorizontalCalendarAdapter adapter = new HorizontalCalendarAdapter(list, context, drawable, pos);
